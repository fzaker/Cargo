...
<g:set var="entityName" value="${message(code: 'costEstimation.search.label')}"/>
<title><g:message code="costEstimation.search.label"/></title>
...
<div id='costEstimSrch'>
    <div class='inner'>
        <div class='fheader'><g:message code="costEstimation.search.label"/></div>
