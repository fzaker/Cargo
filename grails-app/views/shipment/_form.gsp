...
<div class="fieldcontain ${hasErrors(bean: shipmentInstance, field: 'originCnt', 'error')} required">
    ...
    <g:select id="originCnt" name="originCnt.id" from="${cargo.Country.list()}" optionKey="id" required=""
              value="${shipmentInstance?.originCnt?.id}" class="many-to-one"/>
</div>
...
<div class="fieldcontain ${hasErrors(bean: shipmentInstance, field: 'originCty', 'error')} required">
    ...
    <g:select id="originCty" name="originCty.id" from="${cargo.City.list()}" optionKey="id" required=""
              value="${shipmentInstance?.originCty?.id}" class="many-to-one"/>
</div>
...
<div class="fieldcontain ${hasErrors(bean: shipmentInstance, field: 'destinationCnt', 'error')} required">
    ...
    <g:select id="destinationCnt" name="destinationCnt.id" from="${cargo.Country.list()}" optionKey="id" required=""
              value="${shipmentInstance?.destinationCnt?.id}" class="many-to-one"/>
</div>
...
<div class="fieldcontain ${hasErrors(bean: shipmentInstance, field: 'destinationCty', 'error')} required">
    ...
    <g:select id="destinationCty" name="destinationCty.id" from="${cargo.City.list()}" optionKey="id" required=""
              value="${shipmentInstance?.destinationCty?.id}" class="many-to-one"/>
</div>
...
<div class="fieldcontain ${hasErrors(bean: shipmentInstance, field: 'freightCharge', 'error')} ">
    ...
    <g:select name="freightCharge" from="${shipmentInstance.constraints.freightCharge.inList}"
              value="${shipmentInstance?.freightCharge}" valueMessagePrefix="shipment.freightCharge"
              noSelection="['': '']"/>
</div>

<div class="fieldcontain ${hasErrors(bean: shipmentInstance, field: 'HBL', 'error')} ">
    <label for="HBL">
        <g:message code="shipment.HBL.label" default="HBL"/>

    </label>
    <g:textField name="HBL" value="${shipmentInstance?.HBL}"/>
</div>
...
<div class="fieldcontain ${hasErrors(bean: shipmentInstance, field: 'shipper', 'error')} ">
    ...
    <g:select id="shipper" name="shipper.id" from="${cargo.ForwardingReference.list()}" optionKey="id"
              value="${shipmentInstance?.shipper?.id}" class="many-to-one" noSelection="['null': '']"/>
</div>
...
<div class="fieldcontain ${hasErrors(bean: shipmentInstance, field: 'consignee', 'error')} ">
    ...
    <g:select id="consignee" name="consignee.id" from="${cargo.ForwardingReference.list()}" optionKey="id"
              value="${shipmentInstance?.consignee?.id}" class="many-to-one" noSelection="['null': '']"/>
</div>
...
<div class="fieldcontain ${hasErrors(bean: shipmentInstance, field: 'notifyParty', 'error')} ">
    ...
    <g:select id="notifyParty" name="notifyParty.id" from="${cargo.ForwardingReference.list()}" optionKey="id"
              value="${shipmentInstance?.notifyParty?.id}" class="many-to-one" noSelection="['null': '']"/>
</div>
...
<div class="fieldcontain ${hasErrors(bean: shipmentInstance, field: 'agent', 'error')} ">
    ...
    <g:select id="agent" name="agent.id" from="${cargo.ForwardingReference.list()}" optionKey="id"
              value="${shipmentInstance?.agent?.id}" class="many-to-one" noSelection="['null': '']"/>
</div>
...
<div class="fieldcontain ${hasErrors(bean: shipmentInstance, field: 'cargoItems', 'error')} ">
    ...
    <ul class="one-to-many">
        ...
        <li class="add">
            <g:link controller="cargoItem" action="create"
                    params="['shipment.id': shipmentInstance?.id]">${message(code: 'default.add.label', args: [message(code: 'cargoItem.label', default: 'CargoItem')])}</g:link>
        </li>
    </ul>
...
<div class="fieldcontain ${hasErrors(bean: shipmentInstance, field: 'currency', 'error')} ">
    ...
    <g:textField name="currency" value="${shipmentInstance?.currency}"/>
</div>
...
<div class="fieldcontain ${hasErrors(bean: shipmentInstance, field: 'frieghts', 'error')} ">
    ...
    <ul class="one-to-many">
        ...
        <li class="add">
            <g:link controller="freight" action="create"
                    params="['shipment.id': shipmentInstance?.id]">${message(code: 'default.add.label', args: [message(code: 'freight.label', default: 'Freight')])}</g:link>
        </li>
    </ul>
