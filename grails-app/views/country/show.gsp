	...
	<body>
		...
		<div id="show-country" class="content scaffold-show" role="main">
			...
			<ol class="property-list country">
				...
				<li class="fieldcontain">
					<span id="persianTitle-label" class="property-label"><g:message code="country.persianTitle.label" default="Persian Title" /></span>
					
						<span class="property-value" aria-labelledby="persianTitle-label"><g:fieldValue bean="${countryInstance}" field="persianTitle"/></span>
