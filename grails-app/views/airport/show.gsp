	...
	<body>
		...
		<div id="show-airport" class="content scaffold-show" role="main">
			...
			<ol class="property-list airport">
				...
				<li class="fieldcontain">
					<span id="title-label" class="property-label"><g:message code="airport.title.label" default="Title" /></span>
					
						<span class="property-value" aria-labelledby="title-label"><g:fieldValue bean="${airportInstance}" field="title"/></span>
				...
				<li class="fieldcontain">
					<span id="abbreviation-label" class="property-label"><g:message code="airport.abbreviation.label" default="Abbreviation" /></span>
					
						<span class="property-value" aria-labelledby="abbreviation-label"><g:fieldValue bean="${airportInstance}" field="abbreviation"/></span>
